...
readonly class AciPaymentGatewayResponseAdapter implements PaymentGatewayResponseAdapterInterface
{
    ...
    public function adaptResponse(array $apiResponse): UnifiedPaymentResponseDTO
    {
        return $this->unifiedPaymentResponseDTO::init([
                ...
                'created_at' => new DateTimeImmutable($apiResponse['timestamp']),
                'amount' => $apiResponse['amount'],
                'currency' => $apiResponse['currency'],
                'card_bin' => $apiResponse['cardBin'],
            ]
        );
    }
}